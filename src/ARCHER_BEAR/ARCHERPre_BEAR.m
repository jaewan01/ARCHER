%
% ARCHERPre_BEAR: Pre-processing phase of ARCHER using BEAR.
%
% Parameters
...
function [PREP,is_clique] = ARCHERPre_BEAR(R,W,c)
    % number of nodes
    num_v = size(W, 1);
    ...
    if is_clique
        ...
        [PREP]=BearPre(sparse(S), c_prime, 0);
    end
